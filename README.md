...
iexec/
├── packages/
│   ├── layerzero/              # Smart contracts
│   │   ├── contracts/
│   │   │   ├── PocoOApp.sol    # Main OApp contract
│   │   │   ├── interfaces/
│   │   │   ├── libraries/
│   │   │   └── mocks/
...
│   │   └── layerzero.config.ts # LZ configuration
│   │
│   └── cross-chain-tx/         # TypeScript scripts
│       ├── src/
│       │   ├── matchorder.ts   # Main script
